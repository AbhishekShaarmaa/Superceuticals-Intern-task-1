...
async function modifyPDF(input, output, testFields) {
  try {
    ...
    const fields = [
      ...
      { x: 335, y: height - 196, width: 110, height: 10, text: testFields.Chinkungunya_IgMIgG, color: rgb(0, 0, 0) },
    ];
...
// modifyPDF('../PDF/30_chikungunya.pdf', '../results/30_chikungunya.pdf', testFields);
