...
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
  try {
    ...
    const fields = [
      ...
      { x: 315, y: height - 196, width: 110, height: 10, text: userData.Spneumonia, color: rgb(0, 0, 0) },
    ];
...
module.exports = { modifyPDF, input: './PDF/28_Dengue_Ns1_AG.pdf', output: './results/28_Dengue_Ns1_AG.pdf' };
=======
// Sample user data
const userData = {
  name: 'Abhishek',
...
// Modify the PDF with the specified input and output file paths and user data
modifyPDF('../PDF/28_Dengue_Ns1_AG.pdf', '../results/28_Dengue_Ns1_AG.pdf', userData);
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
