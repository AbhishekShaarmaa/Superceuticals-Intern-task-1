...
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
  try {
    ...
    const fields = [
      ...
      { x: 300, y: height - 196, width: 110, height: 10, text: userData.Spneumonia, color: rgb(0, 0, 0) },
    ];
...
module.exports = { modifyPDF, input: './PDF/26_S-pneumonia ag.pdf', output: './results/26_S-pneumonia ag.pdf' };
=======
// Sample user data
const userData = {
  name: 'Abhishek',
...
// Modify the PDF with the specified input and output file paths and user data
modifyPDF('../PDF/26_S-pneumonia ag.pdf', '../results/26_S-pneumonia ag.pdf', userData);
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
