...
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
  try {
    ...
    const fields = [
      ...
      { x: 300, y: height - 196, width: 90, height: 10, text: userData.UAlbumin, color: rgb(0, 0, 0) },
    ];
...
module.exports = { modifyPDF, input: './PDF/23_rsv-ag.pdf', output: './results/23_rsv-ag.pdf' };
=======
// Sample user data
const userData = {
  name: 'Abhishek',
...
// Modify the PDF with the specified input and output file paths and user data
modifyPDF('../PDF/23_rsv-ag.pdf', '../results/23_rsv-ag.pdf', userData);
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
