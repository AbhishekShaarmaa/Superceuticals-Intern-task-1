...
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
  try {
    ...
    const fields = [
      ...
      { x: 335, y: height - 196, width: 110, height: 10, text: userData.Chinkungunya_IgMIgG, color: rgb(0, 0, 0) },
    ];
...
module.exports = { modifyPDF, input: './PDF/30_chikungunya.pdf', output: './results/30_chikungunya.pdf' };
=======
// Sample user data
const userData = {
  name: 'Abhishek',
...
// Modify the PDF with the specified input and output file paths and user data
modifyPDF('../PDF/30_chikungunya.pdf', '../results/30_chikungunya.pdf', userData);
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
