...
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
  try {
    ...
    const fields = [
      ...
      { x: 290, y: height - 196, width: 110, height: 10, text: userData.StrepAAg, color: rgb(0, 0, 0) },
    ];
...
module.exports = { modifyPDF, input: './PDF/27_strep-ag.pdf', output: './results/27_strep-ag.pdf' };
=======
// Sample user data
const userData = {
  name: 'Abhishek',
...
// Modify the PDF with the specified input and output file paths and user data
modifyPDF('../PDF/27_strep-ag.pdf', '../results/27_strep-ag.pdf', userData);
>>>>>>> 0edee28fe42ce9cd266cd795edf83f40de36a5a5
