...
async function modifyPDF(input, output, testFields) {
  try {
    ...
    const fields = [
      ...
      { x: 315, y: height - 196, width: 110, height: 10, text: testFields.Spneumonia, color: rgb(0, 0, 0) },
    ];
...
// modifyPDF('../PDF/28_Dengue_Ns1_AG.pdf', '../results/28_Dengue_Ns1_AG.pdf', testFields);
